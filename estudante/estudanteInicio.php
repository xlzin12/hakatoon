...
<body class="d-flex flex-column min-vh-100">
    ...
    <!-- ══ HEADER ══ -->
    <header class="d-flex justify-content-between align-items-center bg-white py-2 px-3 border-bottom">
        <img src="../assets/imagens/logo-unialfa.png" style="width: 180px;" alt="Logo UniALFA">
        <span class="fw-semibold text-muted d-none d-md-inline">Portal de Estágios</span>
        <div class="d-flex align-items-center gap-3">
           
            <div class="rounded-circle bg-primary d-flex align-items-center justify-content-center text-white fw-bold"
                 style="width:36px;height:36px;background-color:var(--cor-azul-claro)!important;font-size:.9rem;">
                <?php echo mb_strtoupper(mb_substr($nomeAluno, 0, 1)); ?>
            </div>
        </div>
    </header>
    ...
    <main class="d-flex flex-grow-1 align-items-stretch">
        ...
        <!-- ── Sidebar ── -->
        <nav class="nav-estagios d-flex flex-column">
            <a href="painelEstudante.php" class="mt-3 ativo">
                <img src="../assets/imagens/portal-estagio/inicio.png" alt="">
                <span>Início</span>
            </a>
            <a href="vagasEstudante.php" class="my-1">
                <img src="../assets/imagens/portal-estagio/Vagas.png" alt="">
                <span>Vagas</span>
            </a>
            <a href="candidaturasEstudante.php" class="my-1">
                <img src="../assets/imagens/portal-estagio/candidatos.png" alt="">
                <span>Candidaturas</span>
            </a>
            <a href="perfilEstudante.php" class="my-1">
                <img src="../assets/imagens/portal-estagio/Perfil.png" alt="">
                <span>Perfil</span>
            </a>
            <a href="../index.php" class="mt-auto mb-4">
 ...
 */
        ...
        .nav-estagios {
            ...
            flex-shrink: 0;
            background: #fff;
            border-right: 3px solid var(--cor-borda-clara, #EBEBEB);
            min-height: 100%;
        }
        .nav-estagios a {
            display: flex;
        ...
        .nav-estagios a:hover { background-color: #f0f4f8; transform: none; }
        .nav-estagios a.ativo {
            background-color: #f0f4f8;
            border-left: 4px solid var(--cor-azul-claro, #17A2B8);
            color: var(--cor-azul-claro, #17A2B8);
        }
        .nav-estagios a img { width: 22px; margin-right: 12px; flex-shrink: 0; }
        ...
        .card-vaga:hover { box-shadow: 0 4px 14px rgba(0,0,0,.08); }
        .icone-vaga-box {
            width: 48px;
            height: 48px;
            background: #f0f4f8;
        ...
        .icone-vaga-box i { font-size: 1.35rem; color: var(--cor-azul-principal, #0056A3); }
        ...
        .dot-sep { color: #adb5bd; margin: 0 4px; }
